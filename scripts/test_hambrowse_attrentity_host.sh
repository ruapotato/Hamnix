...
if ! adder_bin x86_64-linux user/hambrowse_host.ad "$BIN" 2>"$OUT/attrentity_compile.log"; then
...
if ! adder_bin x86_64-adder-user user/hambrowse.ad "$OUT/hambrowse_native.elf" 2>"$OUT/attrentity_native.log"; then
