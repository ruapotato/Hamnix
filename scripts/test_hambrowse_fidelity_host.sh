...
if ! adder_bin x86_64-linux user/hambrowse_host_gfx.ad "$BIN" 2>"$OUT/fid_compile.log"; then
...
if ! adder_bin x86_64-adder-user user/hambrowse.ad "$OUT/fid_native.elf" 2>"$OUT/fid_native.log"; then
